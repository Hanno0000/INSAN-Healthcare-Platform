...
| **5%** | of the knowledge base written — 2 files for ~40 entities | 14 files. 12 build a campaign card, covering 54 of 132 scheduled slots today and 60 after one rename in the sheet; 2 await operator facts and would add 24 more |
...
**54 of 132 slots** are covered today, **60 once the Kabarona rename below
lands**, and **84** once the two 🟠 files are filled. The middle column is the
